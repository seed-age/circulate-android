...
import com.ecology.view.seedland.circulate.view.CommonGroupDepartmentItemHolder;
...
public class CommonGroupFragment extends CirculateBaseFragment implements OrganizationMemberItemHolder.OnNodeSelectListener, CommonGroupDepartmentItemHolder.ToggleListener {
...
//            }
            if (value.member != null) {
                outer:for (UserInfo userInfo : value.member) {
                    ...
                    memberItemHolder.setOnNodeSelectListener(CommonGroupFragment.this);
