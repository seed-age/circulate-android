...
import cc.seedland.oa.circulate.modle.net.webdownload.AgentWebDownloader;
import cc.seedland.oa.circulate.modle.net.webdownload.DefaultDownloadImpl;
import cc.seedland.oa.circulate.modle.net.webdownload.DownloadListenerAdapter;
import cc.seedland.oa.circulate.modle.net.webdownload.DownloadingService;
    ...
    private void openFile(final String filePath)
    {
        ...
        try
        {
            ...
            if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.N) {
                ...
                uri = FileProvider.getUriForFile(this, "cc.seedland.oa.circulate.fileprovider", file);
            } else {
